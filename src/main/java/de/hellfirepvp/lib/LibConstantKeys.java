...
public class LibConstantKeys {
    ...
    public static final String CONFIG_DATA_WORLD_SPAWNER_TICKSPEED = "worldSpawnerTickSpeed";
    ...
    public static final String CONFIG_DATA_LEASH_VIOLATION_TOLERANCE = "leashViolationTolerance";
    public static final String CONFIG_DATA_ENABLE_PLMETRICS = "enablePluginMetrics";
    ...
    public static final String CONFIG_DATA_RESPECT_DENY_FLAG = "respectWorldGuardDenySpawnFlag";
    public static final String CONFIG_DATA_RESPECT_TYPES_FLAG = "respectWorldGuardMobSpawningFlag";
