...
public class NBTProviderImpl implements NBTProvider
{
    ...
    public ItemStack loadStack(final WrappedNBTTagCompound savedStack) {
        ...
        out = MinecraftServer.getServer().getDataConverterManager().a((DataConverterType)DataConverterTypes.ITEM_INSTANCE, out);
        return CraftItemStack.asBukkitCopy(new net.minecraft.server.v1_11_R1.ItemStack(out));
    }
